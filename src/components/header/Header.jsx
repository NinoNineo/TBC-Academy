            ...
            <header className="w-full bg-white fixed top-0 left-0 right-0 h-20 border-b border-solid z-10">
                <nav className="flex justify-between items-center w-9/12 m-auto">
                    ...
                    <ul className="flex justify-between items-center gap-4">
                        ...
                        <li className="text-blue-900 font-bold"><NavLink to="/" className="flex justify-center items-center gap-2 hover:opacity-70">
